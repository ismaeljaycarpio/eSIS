<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="change-password.aspx.cs" Inherits="eSIS.Account.change_password" %>
                ...
                <div class="panel-body">
                    <div class="form">
                        <asp:ChangePassword ID="ChangePassword1"
                            runat="server"
                            CancelDestinationPageUrl="~/Default"
